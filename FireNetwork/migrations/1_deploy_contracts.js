...
module.exports = async function (deployer, network, accounts) {
        return deployer.then(async () => {
                ...
                const {
                    SETTER_ADDRESS = "0x21c2d113FF68Db224a87437B7C7D0ee5DdC13A7F",
                    SWAPPER_ADDRESS = "0x21c2d113FF68Db224a87437B7C7D0ee5DdC13A7F",
                    TOKEN_NAME = "Test",
                    TOKEN_SYMBOL = "FIRE",
                    HEX2T_ADDRESS = "0x21c2d113FF68Db224a87437B7C7D0ee5DdC13A7F",
                } = process.env;
